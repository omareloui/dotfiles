{
  ...
  home.file.".config/waybar/modules.json".text = let
    terminalEmulatorRun = "${lib.getExe pkgs.wezterm} -e";
  in
    builtins.toJSON {
      # Workspaces
      "hyprland/workspaces" = {
      ...
      "wlr/taskbar" = {
        ...
        ignore-list = ["scratchpad" "kitty" "Picture in picture" "wezterm"];
        app_ids-mapping = {
      ...
      cpu = {
        format = "/ C {usage}% ";
        on-click = "${terminalEmulatorRun} ${lib.getExe pkgs.bottom}";
      };
