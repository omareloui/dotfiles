...
class SnapObjects(inkex.EffectExtension):
    ...
    def add_arguments(self, pars):
        ...
        pars.add_argument('--max-dist', dest='max_dist',
                          action='store', type=float, default=25.0,
                          help='Maximum distance to be considered a "nearby" point')
        pars.add_argument('--controls', dest='controls',
                          action='store', type=inkex.Boolean, default=True,
                          help='Snap control points')
        pars.add_argument('--ends', dest='ends',
                          action='store', type=inkex.Boolean, default=True,
                          help='Snap endpoints')
        pars.add_argument('--first-only', dest='first_only',
                          action='store', type=inkex.Boolean, default=True,
                          help='Modify only the first selected path')
