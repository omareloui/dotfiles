...
set("<leader>s+", "<Cmd>resize +5<CR>", "Increase window height")
set("<leader>s-", "<Cmd>resize -5<CR>", "Decrease window height")
set("<leader>s>", "<Cmd>vertical resize +5<CR>", "Increase window width")
set("<leader>s<", "<Cmd>vertical resize -5<CR>", "Decrease window width")
